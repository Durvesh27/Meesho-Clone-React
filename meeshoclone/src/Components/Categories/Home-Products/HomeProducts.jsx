...
<div className="body">
  <div className="section-3">
    <h2 style={{margin: '15px 0px'}}>Clocks</h2>
    ...
    <div className="section-3flex">
      ...
      <div className="section-3right">
        <div className="main">
          <img src="https://images.meesho.com/images/products/32022906/n0nex_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/3257573/1_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/9029651/72c36_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/11733510/ae80c_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/93510461/opt4z_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/15895356/ecf0b_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/10056613/a0a27_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/34656665/prck1_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/106655375/4cyzz_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/278669321/rmekp_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/11730324/a89cd_400.webp" alt />
          <div className="text">
        ...
        <div className="main">
          <img src="https://images.meesho.com/images/products/109247104/ly055_400.webp" alt />
          <div className="text">
